...
import { Download, Plus, Trash2, ChevronDown, ChevronRight, FileText, List, Lock, Send, CheckCircle, XCircle, BarChart2, DollarSign, Target, PieChart, Edit } from 'lucide-react';
...
const KARNOT_LOGO_BASE64 = "data:image/png;base64,-";
...
const QuoteCalculator = ({ onSaveQuote, nextQuoteNumber, initialData = null }) => {
    ...
    const [docGen, setDocGen] = useState({ quote: true, proForma: true, bir: false, landedCost: true });
    ...
    const generatePDF = () => {
        ...
        const formatCurrency = (num, currency = "USD") => {
            if (currency === "PHP") {
                return `₱${(num * costing.forex).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`;
            }
        ...
        const totalsHTML = (isProForma) => `<div style="margin-top: 20px; text-align: right; font-size: 12px; page-break-inside: avoid;"><table style="margin-left: auto; width: 280px; border-collapse: collapse;"><tr><td style="padding: 6px;">Subtotal</td><td style="padding: 6px; text-align: right;">${formatCurrency(subtotal)}</td></tr>${commercialTerms.discount > 0 ? `<tr><td style="padding: 6px;">Discount (${commercialTerms.discount}%)</td><td style="padding: 6px; text-align: right;">-${formatCurrency(totalDiscount)}</td></tr>` : ''}<tr style="font-weight: bold; font-size: 14px; border-top: 2px solid #333;"><td style="padding: 8px 6px;">${isProForma ? 'Total Amount Due' : 'Total Amount'}</td><td style="padding: 8px 6px; text-align: right;">${formatCurrency(finalSalesPrice)}</td></tr></table></div>`;
        const landedCostHTML = `<div style="margin-top: 25px; padding-top: 15px; border-top: 1px solid #eaeaea; page-break-inside: avoid;"><h3 style="font-size: 13px; color: #333;">Estimated Landed Cost Breakdown (USD)</h3><table style="width: 350px; font-size: 11px; border: 1px solid #ccc;"><tr style="background-color: #f9f9f9;"><td style="padding: 5px; border-bottom: 1px solid #ccc;">Equipment Price (Ex-Works, after discount)</td><td style="padding: 5px; text-align: right; border-bottom: 1px solid #ccc;">${formatCurrency(finalSalesPrice)}</td></tr><tr><td style="padding: 5px; border-bottom: 1px solid #ccc;">Freight Cost</td><td style="padding: 5px; text-align: right; border-bottom: 1px solid #ccc;">${formatCurrency(costing.transport)}</td></tr><tr><td style="padding: 5px; border-bottom: 1px solid #ccc;">Duties (${costing.duties}%)</td><td style="padding: 5px; text-align: right; border-bottom: 1px solid #ccc;">${formatCurrency(finalSalesPrice * (costing.duties / 100))}</td></tr><tr><td style="padding: 5px; border-bottom: 1px solid #ccc;">VAT / IVA (${costing.vat}%)</td><td style="padding: 5px; text-align: right; border-bottom: 1px solid #ccc;">${formatCurrency(finalSalesPrice * (costing.vat / 100))}</td></tr><tr><td style="padding: 5px; border-bottom: 1px solid #ccc;">Broker & Handling Fees</td><td style="padding: 5px; text-align: right; border-bottom: 1px solid #ccc;">${formatCurrency(costing.broker)}</td></tr><tr style="font-weight: bold; background-color: #f0f0f0;"><td style="padding: 5px;">Total Estimated Landed Cost</td><td style="padding: 5px; text-align: right;">${formatCurrency(finalSalesPrice + costing.transport + (finalSalesPrice * (costing.duties / 100)) + (finalSalesPrice * (costing.vat / 100)) + costing.broker)}</td></tr></table></div>`;
        ...
        if (docGen.quote) generatedDocumentsHTML += `<div class="page">${companyHeaderHTML('Sales Quotation', { label: 'Quote ID', value: quoteIdString })}${customerInfoHTML('Quote For')}${lineItemsTableHTML}${totalsHTML(false)}${docGen.landedCost ? landedCostHTML : ''}${termsAndConditionsHTML}</div>`;
        if (docGen.proForma) generatedDocumentsHTML += `<div class="page">${companyHeaderHTML('Pro Forma Invoice', { label: 'Reference', value: `PF-${quoteIdString}`, dueDate: commercialTerms.dueDate })}${customerInfoHTML('Bill To')}${lineItemsTableHTML}${totalsHTML(true)}${docGen.landedCost ? landedCostHTML : ''}${bankDetailsHTML}</div>`;
        
        if (!generatedDocumentsHTML) { alert("Please select at least one document type to generate."); return; }
        const fullHtml = `<html><head><style>body{font-family: 'Helvetica', Arial, sans-serif;}.page{width:210mm;min-height:297mm;padding:20mm;margin:auto;box-sizing:border-box;page-break-after:always;background:white;}.page:last-child{page-break-after:auto;}</style></head><body>${generatedDocumentsHTML}</body></html>`;
        
        const element = document.createElement('div');
        element.innerHTML = fullHtml;
        html2pdf().from(element).set({ margin: 0, filename: `Karnot-Documents-${quoteIdString.replace(/\s/g, '')}.pdf`, jsPDF: { unit: 'mm', format: 'a4', orientation: 'portrait' } }).save();
    };
    ...
    return (
        <Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-6 mt-6">
                <div>
                    <h3 className="text-xl font-bold border-b-2 border-orange-500 pb-2">3. Landed Cost & Docs</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                     ...
                     <div className="flex gap-6 mt-4">
                        <Checkbox label="Incl. Landed Cost" checked={docGen.landedCost} onChange={e => handleInputChange(setDocGen, 'landedCost', e.target.checked)} />
                        <Checkbox label="Gen. Quotation" checked={docGen.quote} onChange={e => handleInputChange(setDocGen, 'quote', e.target.checked)} />
                        <Checkbox label="Gen. Pro Forma" checked={docGen.proForma} onChange={e => handleInputChange(setDocGen, 'proForma', e.target.checked)} />
                    </div>
                </div>
                <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
                <Textarea label="Terms & Conditions (for Quotation)" rows="8" value={termsAndConditions} onChange={e => setTermsAndConditions(e.target.value)} />
                <Textarea label="Bank Details (for Pro Forma)" rows="8" value={bankDetails} onChange={e => setBankDetails(e.target.value)} />
            </div>
            <div className="flex justify-between items-center mt-8 border-t pt-6">
                 <Button onClick={handleSave} variant="success" className="w-full md:w-auto"><Plus className="mr-2"/>{initialData ? 'Update Quote in CRM' : 'Save Quote to CRM'}</Button>
