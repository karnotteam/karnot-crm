...
const AgentModal = ({ territory, agents = [], onClose, onSave }) => {
...
const TerritoryManagement = ({ territories = [], agents = [], companies = [], user }) => {
...
// Haversine distance calculation (reuse from proximity search)
